/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 837c98fbed485277c4eaf3c7e6291810)
...
declare namespace Cloudflare {
	interface Env {
		...
		DEV_AUTH_TOKEN: "secret_dev_key";
		DEV_USER_ID: "the-dev-user-id";
		CLERK_SECRET_KEY: string;
		USER_STREAM: DurableObjectNamespace<import("./src/index").UserStream>;
		D1: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "CLERK_PUBLISHABLE_KEY" | "DEV_AUTH_TOKEN" | "DEV_USER_ID" | "CLERK_SECRET_KEY">> {}
}
