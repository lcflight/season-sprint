/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: fe854eeea0077a09b86276bd6deed18f)
// Runtime types generated with workerd@1.20250906.0 2025-09-11 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		DATABASE_URL: "file:./dev.db";
		CLERK_PUBLISHABLE_KEY: "the-clerk-publishable-key";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY" | "DEV_AUTH_TOKEN" | "DEV_USER_ID">> {}
}
